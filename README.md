...
- Raid signup board (`/raid-schedule`): creates Support/DPS slots, waitlist, RSVP, auto-lock, and derives party size from the selected raid (Act 4/Kazeros = 8, Serca = 4)
