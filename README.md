...
- **Title**: `⚠️ Raid Check · <raid label> (<minItemLevel>) · Page X/Y` - iLvl threshold nhét trong parens cạnh raid label (ví dụ `Act 4 Normal (1700)`), không còn ở description line.
