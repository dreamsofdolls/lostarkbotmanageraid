...
module.exports = {
  ...
  "raid-status": {
    ...
    filter: {
      ...
      allRaidsDone: "Tất cả raids (DONE - {soloDone}/{soloTotal} solo raid done)",
      allRaidsPending: "Tất cả raids ({n} chưa clear - {soloDone}/{soloTotal} solo raid done)",
  ...
  "raid-check": {
    ...
    filter: {
      ...
      allUsersDone: "Tất cả user (đã xong)",
      allUsersPending: "Tất cả user ({n} chưa clear)",
      userDone: "{name} (đã xong)",
      userPending: "{name} ({n} chưa clear · {supports}🛡️ {dps}⚔️)",
      allRosters: "Tất cả roster ({pending} chưa clear · {success} đã xong)",
      rosterState: "{name} ({pending} chưa clear · {success} đã xong)",
      noMatchingRosters: "Không có roster phù hợp bộ lọc",
      allRaidsDone: "Tất cả raid (đã xong)",
      allRaidsPending: "Tất cả raid ({n} chưa clear)",
