...
module.exports = {
  ...
  "local-sync-discord": {
    ...
    stateDescriptions: {
      ...
      applied: "Preview này đã được áp dụng.",
      cancelled: "Preview đã bị huỷ và không thay đổi tiến độ raid.",
      superseded: "Một lần quét mới hơn đã thay thế preview này. Mở `/raid-status` rồi chọn `🗃️ Local Sync` để xem bản mới nhất.",
      expired: "Preview đã quá hạn. Mở Local Reader và gửi một preview mới nhé.",
