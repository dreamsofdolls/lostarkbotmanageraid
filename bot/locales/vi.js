...
module.exports = {
  ...
  "raid-schedule": {
    ...
    notice: {
      ...
      helpDescription: "Bấm **Tham gia** để chọn character. **Đến muộn** vẫn giữ chỗ cho cậu, **Có thể/Vắng** thì nhường chỗ cho người trong hàng chờ. Lead dùng **Quản lý** để Khóa/Mở khóa, End, đặt phòng, sửa giờ hoặc hủy event nha.",
      manageTitle: "Bảng điều khiển của lead",
      manageDescription: "Chọn thao tác cho event này nha~ (Kick member thì Artist để dành phase sau)",
    ...
    sections: {
      ...
      "raid-schedule-preview": {
        ...
        notes: [
          ...
          "**Manage**: lead bấm Quản lý để Khóa/Mở khóa, End, đặt phòng/mật khẩu, sửa giờ, hủy event, hoặc 🧩 Phân turn.",
          ...
          "**Preview hiện tại**: kick member chưa bật; board/RSVP/waitlist/room/time/cancel/phân-turn/show đã dùng được.",
        ],
        optionDescriptions: {
