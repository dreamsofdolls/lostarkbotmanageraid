...
module.exports = {
  ...
  "raid-schedule": {
    board: {
      ...
      startLine: "Bắt đầu {rel} · {abs}",
      leadLine: "Lead: {lead}",
      roomLine: "Room: `{room}`",
      progress: "Comp: **{n}/{size}** · hàng chờ **{waitlist}**",
      emptySlot: "trống",
      title: {
        open: "📅 {title}",
        locked: "🔒 {title}",
      ...
      rsvpHeader: "RSVP",
      rsvpTentative: "Có thể",
      rsvpAbsent: "Vắng",
      footer: {
        open: "Raid schedule · ID {id}",
        locked: "Đã khóa đăng ký · ID {id}",
        cleared: "Đã end và khóa bảng · ID {id}",
        cancelled: "Đã hủy · ID {id}",
      },
    },
    btn: {
      join: "Tham gia",
    ...
    picker: {
      title: "Chọn character để tham gia",
      placeholder: "Chọn character của cậu",
      pickerDescription: "Có {count} character đủ điều kiện. Chọn 1 character để ghi danh.",
      pickerDescriptionLimited: "Có {count} character đủ điều kiện; Discord chỉ cho hiện {limit} lựa chọn đầu.",
      alreadyClearedSuffix: "· đã clear",
      role: {
        support: "Support",
        dps: "DPS",
      },
    ...
    notice: {
      notManagerTitle: "Chỉ Raid Manager dùng được",
      notManagerDescription: "Lệnh này chỉ mở cho các Discord ID trong `RAID_MANAGER_ID`.",
      managerOnlyTitle: "Chỉ Raid Manager thao tác được",
      managerOnlyDescription: "Nút lead chỉ dành cho Raid Manager.",
      unknownTitle: "Không nhận ra thao tác",
      unknownDescription: "Interaction này không khớp với flow raid-schedule hiện tại.",
      guildOnlyTitle: "Chỉ dùng trong server",
      guildOnlyDescription: "`/raid-schedule` cần channel server để đăng board công khai.",
      invalidModeTitle: "Raid / mode không hợp lệ",
      invalidModeDescription: "Mode này không tồn tại cho raid đã chọn. Chọn lại giúp tớ nhé.",
      invalidTimeTitle: "Giờ bắt đầu không hợp lệ",
      invalidTimeDescription: "Dùng `HH:MM`, `+2h`, hoặc `+90m`. Với `HH:MM`, bot dùng timezone theo `/raid-language` của lead.",
      missingEventTitle: "Không thấy event",
      missingEventDescription: "Board này có thể đã bị xóa hoặc ID đã cũ.",
      eventClosedTitle: "Event đã đóng",
      eventClosedDescription: "Board đã end/hủy hoặc không còn nhận thay đổi này nữa.",
      noRosterTitle: "Cậu chưa có roster",
      noRosterDescription: "Chạy `/raid-add-roster name:<character>` trước rồi quay lại tham gia nhé.",
      noEligibleTitle: "Không có character đủ iLvl",
      noEligibleDescription: "Roster của cậu chưa có character đạt iLvl {ilvl}+ cho raid này.",
      pickerStaleTitle: "Picker đã cũ",
      pickerStaleDescription: "Roster hoặc event đã đổi sau khi picker mở. Bấm Tham gia lại để lấy danh sách mới.",
      joinedTitle: "Đã ghi danh",
      joinedDescription: "**{character}** đã được thêm vào board.",
      joinedRefreshFailedTitle: "Đã ghi danh, nhưng chưa refresh board",
      joinedRefreshFailedDescription: "**{character}** đã được lưu. Nếu board chưa đổi ngay, bấm một nút bất kỳ hoặc tạo lại view sau.",
      lockedTitle: "Board đang khóa",
      lockedDescription: "Board đã khóa nên chỉ còn có thể báo vắng.",
      notJoinedTitle: "Cậu chưa tham gia",
      notJoinedDescription: "Bấm **Tham gia** và chọn character trước rồi mới RSVP được.",
      promotedPing: "{user} **{character}** đã được kéo từ hàng chờ vào comp.",
      endedTitle: "Đã end raid",
      endedDescription: "Auto-clear đã ghi **{updated}/{targets}** character. Lỗi/không update: **{failed}**.",
      roomDeniedTitle: "Room chỉ hiện cho người trong comp",
      roomDeniedDescription: "Cậu cần đang nằm trong slot Support/DPS, không phải hàng chờ hoặc RSVP vắng.",
      roomEmptyTitle: "Chưa có room",
      roomEmptyDescription: "Lead chưa set room/password cho event này.",
      roomTitle: "Room riêng",
      roomDescription: "Room: `{room}`\n{passwordLine}",
      roomPasswordLine: "Password: `{password}`",
      roomNoPasswordLine: "Không có password.",
      helpTitle: "Raid schedule help",
      helpDescription: "Bấm **Tham gia** để chọn character. **Đến muộn** vẫn giữ slot, **Có thể/Vắng** sẽ nhường slot cho hàng chờ. Lead dùng **Khóa/End** để chốt board.",
      manageTitle: "Manage menu chưa bật",
      manageDescription: "MVP hiện có Khóa/Mở khóa/End. Modal chỉnh room/password và các setting nâng cao sẽ đi ở phase tiếp theo.",
    },
  },
  ...
  "raid-help": {
    ...
    sections: {
      ...
      "raid-schedule": {
        ...
        notes: [
          "Raid Manager tạo một board công khai để member tự chọn character từ roster của chính họ.",
          "",
          ...
          "**MVP hiện tại**: manage modal cho room/password và setting nâng cao chưa bật; Lock/Unlock/End đã dùng được.",
        ],
        optionDescriptions: {
