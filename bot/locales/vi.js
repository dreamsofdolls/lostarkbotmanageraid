    ...
    sections: {
      ...
      "raid-schedule-preview": {
        ...
        notes: [
          ...
          "**Manage**: lead bấm Quản lý để Khóa/Mở khóa, End, đặt phòng/mật khẩu, sửa giờ hoặc hủy event.",
          "**End**: khi lead end raid, bot ghi clear cho các character đang nằm trong comp qua đường `/raid-set`.",
          "**Preview hiện tại**: kick member và setting nâng cao chưa bật; board/RSVP/waitlist/room/time/cancel đã dùng được.",
        ],
        optionDescriptions: {
