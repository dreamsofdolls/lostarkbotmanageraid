...
module.exports = {
  ...
  "raid-check": {
    ...
    syncFlow: {
      ...
      reportTitlePartial: {
        variants: [
          "Sync xong, còn vướng vài chỗ",
          "Ngó logs xong, có chỗ chưa trôi",
          "Kéo logs xong, chưa qua hết",
        ],
      },
      reportTitleFailed: {
        variants: [
          "Sync hỏng, chưa ghi được gì",
          "Kéo logs fail hết rồi",
  ...
  "text-parser": {
    ...
    dmFallbackWritten: "đã ghi {entries}",
    dmFallbackAlready: "{entries} đã DONE từ trước",
    dmFallbackReset: "đã reset {entries}",
    dmFallbackAlreadyReset: "{entries} vốn đã trống",
    dmFallbackSeparator: ". ",
    dmFallback: "{icon} <@{userId}> {parts}. _(DM bị tắt - bật \"Allow DMs from server members\" để nhận biên nhận riêng.)_",
    errorNotFound: "{icon} Không tìm thấy trong roster: {names}",
    errorIneligibleCharacter: "{icon} Chưa đủ iLvl: {character} (iLvl {itemLevel}) · {raids}",
    errorIneligibleRaid: "{raidLabel} (cần {minItemLevel}+)",
    ...
    raidUpdateDescription: {
      variants: [
        "Ghi xong **{raids}** raid cho **{count}** character rồi nha~",
        "**{raids}** raid của **{count}** character đã vào sổ~",
        "Tớ đã ghi **{raids}** raid cho **{count}** character, xong một lượt~",
      ],
    },
    raidUpdateNothingNew: {
      variants: [
        "Không có raid nào mới để ghi, mọi thứ đã DONE từ trước rồi~",
        "Mấy raid này cậu clear từ trước rồi, tớ không phải ghi gì thêm~",
        "Sổ đã có hết rồi nha, lần này tớ không cần ghi gì~",
      ],
    },
    raidResetTitle: "Reset Raid",
    raidResetDescription: {
      variants: [
        "Tớ đã reset **{raids}** raid cho **{count}** character, difficulty đang lưu vẫn giữ nguyên.",
        "Xoá sạch **{raids}** raid của **{count}** character rồi, difficulty thì tớ để yên.",
        "**{count}** character đã được reset **{raids}** raid. Difficulty cũ vẫn nguyên đó nha.",
      ],
    },
    raidResetNothing: {
      variants: [
        "Raid này vốn đã trống, tớ không phải xoá gì~",
        "Chưa có progress nào để xoá cả, tớ để yên nha~",
        "Trống sẵn rồi, không cần reset thêm đâu~",
      ],
    },
    tailAlready: "{icon} {n} raid đã DONE từ trước, tớ để nguyên.",
    tailAlreadyReset: "{icon} {n} raid vốn đã trống, tớ để nguyên.",
    tailIneligible: "{icon} {n} raid chưa đủ iLvl nên tớ bỏ qua.",
    tailErrored: "{icon} {n} raid ghi lỗi, cậu gõ lại giúp tớ nha.",
    tailNotFound: "{icon} Không tìm thấy trong roster: {names}",
    rowNeedsItemLevel: "cần {minItemLevel}+",
    rowWriteFailed: "ghi lỗi, gõ lại nha",
