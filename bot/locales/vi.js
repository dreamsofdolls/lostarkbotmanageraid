...
module.exports = {
  ...
  "raid-schedule": {
    ...
    notice: {
      ...
      helpDescription: "Bấm **Tham gia** để chọn character. **Đến muộn** vẫn giữ chỗ cho cậu, **Có thể/Vắng** thì nhường chỗ cho người trong hàng chờ. Lead thì dùng **Khóa/End** để chốt board nha.",
