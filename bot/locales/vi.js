...
module.exports = {
  ...
  "raid-auction": {
    ...
    result: {
      ...
      descriptionTemplate: "**Giá thị trường:** `{marketValue}`  ·  **Chế độ:** {mode}",
      modeProfit: "Có lời (biên 8%)",
      modeBreakeven: "Hòa vốn",
      partyHeader: "🪙 {players} người",
      partyBlockValue: "```\n{bid}\n```\nMỗi người còn lại ({others}) nhận ~`{eachReceives}`\nNgười thắng lời: ~`{winnerNet}`",
      footer: "Công thức từ la-utils · phí bán 5% đã tính sẵn trong bid",
    },
  },
