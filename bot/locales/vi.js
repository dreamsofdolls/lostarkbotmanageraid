...
module.exports = {
  ...
  "local-sync-discord": {
    ...
    noPreviewDescription: [
      "Chưa có preview nào chờ cậu cả nha~",
      "",
      "🗂️ **Local Reader** là trang web đọc thẳng `encounters.db` ngay trên máy cậu. File gốc không rời khỏi máy đâu, Artist chỉ nhận về một bản tóm tắt bé xíu: char nào vừa clear raid nào, gate nào.",
      "",
      "🌐 **1.** {openReader}, chọn `encounters.db` trong `%localappdata%\\LOA Logs\\`",
      "📤 **2.** Bấm nút gửi preview ở cuối trang",
      "✅ **3.** Quay lại đây, ngó kỹ một lượt rồi bấm **Đồng bộ**. Artist chỉ ghi tiến độ raid ở đúng bước này thôi nhé.",
      "",
      "💡 Trình duyệt nhớ file nên chỉ phải chọn một lần. Link mở reader sống 30 phút, preview thì tớ giữ 2 giờ.",
    ],
    noPreviewOpen: {
      link: "Bấm **Mở Local Reader**",
      solo: "Bấm **Solo Local Reader** (link riêng chỉ cậu thấy)",
      none: "Mở Local Reader",
    },
    readerAction: {
      link: "mở **Local Reader**",
      solo: "bấm **Solo Local Reader**",
      none: "mở Local Reader",
    },
    tracker: {
      read: "Đọc log",
      preview: "Xem trước",
      sync: "Đồng bộ",
      nothing: "Không có gì mới",
      busy: "Chờ lượt",
      tempError: "Lỗi tạm thời",
      partial: "Đồng bộ dở",
    ...
    stateDescriptions: {
      ...
      applying: "Artist đang ghi tiến độ raid. Đợi một chút nhé.",
      applied: "Artist đã ghi xong các thay đổi bên dưới.",
      appliedWithRejected: "Artist đã ghi xong các thay đổi bên dưới. Có **{rejected}** mục trong log không ghi được vì không khớp với roster hoặc độ khó cậu đang đặt.",
      cancelled: "Preview đã bị huỷ và không thay đổi tiến độ raid.",
      superseded: "Đã có lần quét mới hơn thay cho preview này. Bấm **Làm mới** để xem bản mới nhất nhé.",
      expired: "Preview đã quá 2 giờ nên Artist không ghi nữa. Cậu {reader} rồi gửi preview mới nhé.",
      failed: "Artist không thể áp dụng preview này.",
      failedLocalOff: "Không thể đồng bộ: **Local Sync đã bị tắt**. Giờ cậu dùng Bible Auto-sync, {reader} để gửi preview mới nhé.",
      failedBibleOff: "Không thể đồng bộ: **Bible Auto-sync đã bị tắt**. Giờ cậu dùng Local Sync đầy đủ, {reader} để gửi preview mới nhé.",
    ...
    rosterFilteredNote: "Đang lọc, **Đồng bộ** vẫn ghi đủ **{count}** roster",
    partyName: "Người cùng party cũng được cập nhật ({count})",
    partyOwnerUnknown: "Chưa rõ tên",
    retryReasons: {
      ...
      party_write_error: "Phần của cậu đã ghi xong. Còn vài roster trong party chưa nhận tiến độ, bấm **Đồng bộ** để thử lại nhé.",
  ...
  "raid-auction": {
    ...
    result: {
      ...
      descriptionTemplate: "📦 **Listing:** `{marketValue}` 🪙  ·  ⚙️ **Chế độ:** {mode}",
      modeProfit: "Có lời (+8% biên)",
      modeBreakeven: "Hòa vốn",
      partyHeader: "🪙 Party {players} người",
      partyBlockValue: "💰 **Bid**\n```\n{bid}\n```\n📤 Mỗi người ({others}): `{eachReceives}`\n💵 Lời (sau phí): `{winnerNet}`",
      footer: "Phí bán 5% đã tính cho cả bid lẫn lời người thắng · Công thức: la-utils",
    },
  },
  "raid-schedule": {
    board: {
      ...
      leadLine: "Lead: {lead}",
      roomLine: "Phòng: `{room}`",
      progress: "Đội hình: **{n}/{size}** · đang chờ **{waitlist}**",
      emptySlot: "còn trống",
      title: {
        open: "📅 {title}",
        locked: "🔒 {title}",
      ...
      rsvpHeader: "📋 RSVP",
      rsvpTentative: "Có thể đến",
      rsvpAbsent: "Báo vắng",
      footer: {
        open: "Bấm Tham gia để Artist xếp chỗ cho nha~ · ID {id}",
        locked: "Đăng ký chốt rồi, hẹn cả nhà giờ G · ID {id}",
        cleared: "Done! Cả nhà chiến đẹp lắm~ · ID {id}",
        cancelled: "Lần này lỡ hẹn rồi, để dịp sau nha · ID {id}",
      },
    },
    btn: {
      join: "Tham gia",
      ...
      setRoom: "Đặt phòng",
      editTime: "Sửa giờ",
      cancelEvent: "Hủy event",
      deleteEvent: "🗑️ Xóa",
      deleteConfirmYes: "🗑️ Xóa hẳn",
      deleteConfirmNo: "Quay lại",
    },
    picker: {
      title: "Chọn character đi raid nào~",
      placeholder: "Pick một bạn trong roster nhé",
      pickerDescription: "Cậu có {count} character đủ sức cho raid này. Chọn 1 bạn để Artist ghi tên lên board nha~",
      pickerDescriptionLimited: "Cậu có {count} character đủ điều kiện, mà Discord chỉ cho Artist hiện {limit} bạn đầu thôi.",
      alreadyClearedSuffix: "· đã clear tuần này",
      role: {
        support: "Support",
        dps: "DPS",
      },
    ...
    modal: {
      roomTitle: "Đặt phòng raid",
      roomNameLabel: "Tên phòng (ai cũng thấy)",
      roomPasswordLabel: "Mật khẩu (chỉ comp thấy, trống nếu không có)",
      timeTitle: "Đổi giờ bắt đầu",
      timeLabel: "Giờ mới: 20:00 / 20h / 21h30 / 8pm / +2h",
    },
    teams: {
      title: "Phân turn cho event",
      intro: "Chọn turn để sửa (hoặc thêm turn mới), rồi tick người từ pool signup. 1 người đi nhiều turn được nha~",
      none: "Chưa có turn nào. Chọn ➕ Turn mới để bắt đầu.",
      turnLine: "**{name}** · {n} người",
      memberCount: "{n} người",
      newTurn: "➕ Turn mới",
      pickTurn: "Chọn turn để sửa...",
      turnNameDefault: "Turn {n}",
      assignTitle: "Xếp người cho {turn}",
      assignIntro: "Tick người cho vào turn này (bỏ tick để gỡ). Người đang ở turn khác vẫn tick lại được nha.",
      pickMembers: "Chọn người cho {turn}...",
    },
    kick: {
      title: "Kick ai khỏi đội?",
      intro: "Chọn người cần gỡ khỏi event (chọn được nhiều). Gỡ xong, nếu có chỗ trống Artist kéo người trong hàng chờ lên luôn nha~",
      placeholder: "Chọn người để kick...",
    },
    addMember: {
    ...
    notice: {
      ...
      notManagerDescription: "Lệnh này Artist chỉ mở cho mấy Discord ID nằm trong `RAID_MANAGER_ID` thôi.",
      ...
      invalidTimeDescription: "Cậu nhập kiểu nào cũng được nha: `20:00`, `20h`, `21h30`, `8pm`, `2000`, `+2h`/`+90m`; hoặc kèm **thứ** `thứ 4 20:00` / `t4 20h` / `cn 8pm`; hoặc **ngày** `5/6 20:00` / `5/6/2026 8pm`. Day/thứ phải kèm giờ. Artist hiểu theo timezone trong `/raid-language` của cậu.",
      missingEventTitle: "Artist không tìm thấy event",
      missingEventDescription: "Board này chắc bị xóa rồi, hoặc ID cũ mất rồi nha.",
      eventClosedTitle: "Event đóng rồi",
      eventClosedDescription: "Board đã end hoặc hủy, không nhận thay đổi này nữa nha.",
      noRosterTitle: "Cậu chưa có roster",
      noRosterDescription: "Chạy `/raid-add-roster name:<character>` trước đã, rồi quay lại tham gia với Artist nhé~",
      noEligibleTitle: "Chưa có character đủ iLvl",
      ...
      joinedRefreshFailedDescription: "**{character}** lưu rồi nha. Board chưa đổi ngay thì cậu bấm nút bất kỳ là nó cập nhật thôi.",
      lockedTitle: "Board đang khóa",
      lockedDescription: "Đăng ký chốt rồi, giờ cậu chỉ còn báo vắng được thôi nha.",
      notJoinedTitle: "Cậu chưa tham gia mà~",
      notJoinedDescription: "Bấm **Tham gia** chọn character trước đã, rồi mới RSVP được nha.",
      promotedPing: "{user} có chỗ trống nên Artist kéo **{character}** từ hàng chờ vào đội rồi nha~",
      endedTitle: "Chốt raid xong~",
      endedDescription: "Artist ghi clear cho **{updated}/{targets}** character rồi. Lỗi/chưa update: **{failed}**.",
      roomDeniedTitle: "Phòng chỉ cho người trong đội thôi",
      roomDeniedDescription: "Cậu cần đang ở slot Support/DPS thì Artist mới cho xem phòng nha, hàng chờ hay báo vắng thì chưa được.",
      roomEmptyTitle: "Chưa có phòng",
      roomEmptyDescription: "Lead chưa set phòng/mật khẩu cho event này. Chờ lead chút nha~",
      roomTitle: "Phòng riêng cho đội",
      roomDescription: "Phòng: `{room}`\n{passwordLine}",
      roomPasswordLine: "Mật khẩu: `{password}`",
      roomNoPasswordLine: "Phòng này không đặt mật khẩu nha.",
      helpTitle: "Artist chỉ cậu dùng board nha~",
      helpDescription: "Bấm **Tham gia** để chọn character. **Đến muộn** vẫn giữ chỗ cho cậu, **Có thể/Vắng** thì nhường chỗ cho người trong hàng chờ. Lead dùng **Quản lý** để Khóa/Mở khóa, End, đặt phòng, sửa giờ, thêm/kick member hoặc hủy event nha.",
      manageTitle: "Bảng điều khiển của lead",
      manageDescription: "Chọn thao tác cho event này nha~",
      roomSavedTitle: "Đặt phòng xong~",
      roomSavedDescription: "Artist lưu phòng **{room}** rồi. Người trong comp bấm nút Phòng là thấy nha.",
      timeSavedTitle: "Đổi giờ xong~",
      timeSavedDescription: "Giờ mới: {rel} · {abs}. Board cập nhật rồi nhé.",
      cancelledTitle: "Event hủy rồi",
      cancelledDescription: "Artist gỡ board rồi, mọi người được báo ngoài channel nha.",
      cancelPingContent: "{users} event raid lỡ hẹn rồi nha~ Lead vừa hủy, để dịp sau mình raid tiếp nhé.",
      teamsNoPoolTitle: "Chưa có ai trong pool",
      teamsNoPoolDescription: "Chưa ai bấm Tham gia nên chưa có người để xếp turn. Đợi mọi người đăng ký đã nha~",
      showNoBoardsTitle: "Cậu không có board nào đang chạy",
      showNoBoardsDescription: "Hiện chưa có board signup nào của cậu đang mở/khóa. Tạo board bằng `/raid-schedule-preview create` trước nha~",
      resurfacedTitle: "Board xuống đáy rồi~",
      resurfacedDescription: "Board **{raid}** giờ nằm ở cuối {channel} rồi - cả nhà tìm thấy ngay nha. [Tới board mới]({link})",
      ...
      allClearedTitle: "Char nào cũng clear hết rồi~",
      allClearedDescription: "Mọi char đủ iLvl của cậu đã clear raid này tuần này rồi nên không cần đăng ký nữa nha. Tuần sau quay lại nhé~",
      addAllClearedTitle: "Char nào cũng clear hết rồi",
      ...
      deleteFailedDescription: "Artist chưa xóa được dữ liệu event nên giữ nguyên board để tránh event ma. Thử lại sau hoặc kiểm tra log Mongo giúp tớ nha.",
      deleteAbortedTitle: "Thôi không xóa nữa",
  ...
  "stuck-nudge": {
    ...
    switchedTitle: "Giờ chạy Local Sync",
    switchedDescription: "<@{target}> đã chuyển từ bible auto-sync sang **local-sync mode**. Mở `/raid-status` rồi chọn `🗃️ Local Sync` để vào console hoặc lấy link Local Reader mới nha~",
    dmTitle: "Local Sync setup",
    dmDescription: "Bấm **Mở Local Reader** để chọn `encounters.db` ở `%localappdata%\\LOA Logs\\`. Reader nhớ file cho lần sau và chỉ gửi preview nhỏ về Discord; cậu xác nhận trong `/raid-status` → `🗃️ Local Sync`. Link có hiệu lực 30 phút.",
  },
  ...
  "raid-remove-roster": {
    ...
    removedRoster: {
      title: "🗑️ Đã xoá roster · {accountName}",
      noChars: "(account không có character nào)",
      withChars: "cùng **{count}** character",
      goldTail: ", kể cả **{gold}** gold tuần này",
      description: "Artist dọn sạch roster **{accountName}** {charPart} khỏi DB rồi nhé.\n\nTiến độ raid trong account này không còn nữa{goldPart}. Muốn dựng lại thì Artist mở picker mới cho cậu.",
      footerReadd: "/raid-add-roster name:{accountName}",
    },
    removedChar: {
      title: "🗑️ Đã xoá character · {characterName}",
      empty: "Roster giờ trống - cậu có thể `/raid-remove-roster` để xoá hẳn account, hoặc `/raid-edit-roster` để add lại chars mới.",
      remaining: "Roster **{accountName}** còn lại **{count}** character: {names}.",
      description: "Artist gỡ {characterName} khỏi roster **{accountName}** rồi nha.\n\n{remainingPart}",
  ...
  "raid-status": {
    ...
    embed: {
      ...
      goldEarnerHint: "_💰 Bật gold-earner bằng `/raid-gold-earner roster:<name>`._",
    },
    filter: {
      placeholder: "Lọc theo raid...",
      rosterPlaceholder: "Lọc theo roster...",
      allRosters: "Rosters",
      rosterState: "{name} (Còn {pending} raid · {solo} solo)",
      noMatchingRosters: "Không có roster phù hợp với bộ lọc",
      unnamedRoster: "Roster chưa đặt tên",
      raidSummary: "Raids (Còn {n} raid · {solo} solo)",
      raidEntryDone: "{label} (DONE)",
      raidEntryPending: "{label} ({n} chưa clear · {supports}🛡️ {dps}⚔️)",
    },
    myRaids: {
      placeholder: "🗓️ Raid của tôi ({n})",
      optionDescTurns: "{role} · {n} turn đã xếp",
      optionDescNoTurns: "{role} · chưa xếp turn",
      youTag: "← bạn",
      emptyTurn: "(chưa có ai)",
      detailTitle: "🗓️ {raid} · Raid của bạn",
      detailIntro: "Khởi raid {rel} · {abs} · ở {channel}",
      roleField: "Vai của bạn",
      roomField: "Phòng",
      roomLine: "`{room}` · mk `{password}`",
      roomLineNoPassword: "`{room}` (không mật khẩu)",
      roomEmpty: "Lead chưa đặt phòng nha~",
      turnsField: "Turn của bạn",
      noTurns: "Lead chưa xếp turn cho bạn, hiện bạn đang ở {role}.",
      detailFooter: "Chỉ hiện phần của bạn · ID {id}",
      notFoundTitle: "Không tìm thấy raid",
      notFoundDescription: "Raid này chắc đã đóng hoặc bị xóa rồi nha.",
    },
    raidView: {
      pendingModeMark: "-> {mode} (sau reset)",
    },
    sync: {
      ...
      localRefreshSuccessTitle: "Đã đọc lại tiến độ",
      localRefreshSuccessDescription: "Card phía trên đang hiện dữ liệu mới nhất từ DB.",
      localRefreshFailedTitle: "Chưa cập nhật được tiến độ",
      localRefreshFailedDescription: "Artist chưa đọc được dữ liệu mới từ DB. Card giữ nguyên như cũ; cậu thử lại sau một chút nhé.",
      buttonFailedTitle: "Nút này chưa chạy được",
      buttonFailedDescription: "Artist gặp lỗi khi xử lý. Card giữ nguyên như cũ; cậu bấm lại sau một chút, vẫn lỗi thì báo Manager nhé.",
      soloCompanionButtonLabel: "Solo Local Reader",
      soloCompanionTitle: "Solo Local Reader đã sẵn sàng",
      soloCompanionDescription: "Dùng link riêng bên dưới để đọc `encounters.db` và gửi preview **Solo** về Discord. Bible Auto-sync vẫn chạy như cũ; tiến độ chỉ được ghi khi cậu bấm **Đồng bộ** trên card Local Sync. Link sống 30 phút và gắn với tài khoản của cậu, đừng chia sẻ nhé.",
      soloCompanionOpenButtonLabel: "Mở Solo Local Reader",
      soloCompanionUnavailableTitle: "Solo Local Reader chưa khả dụng",
      soloCompanionUnavailableDescription: "Máy chủ chưa cấu hình URL công khai cho Local Reader. Báo Manager kiểm tra `PUBLIC_BASE_URL` nhé.",
      soloCompanionFailedTitle: "Không tạo được link Solo Local Reader",
      ...
      rosterRefreshNoUpdateTitle: "Chưa lấy được data mới",
      ...
      rosterRefreshMissingTitle: "Không thấy roster để refresh",
      rosterRefreshMissingDescription: "Artist không tìm thấy roster **{accountName}** trong DB nữa. Mở lại `/raid-status` để lấy session mới nha.",
      rosterRefreshSharedLockedTitle: "Roster share đang ở quyền xem",
      rosterRefreshSharedLockedDescription: "Roster được share dạng view-only nên Artist không ghi refresh vào owner được. Nhờ owner cấp quyền edit nếu cần cập nhật trực tiếp.",
      rosterRefreshFailedTitle: "Refresh roster fail",
      rosterRefreshFailedDescription: "Artist gặp lỗi khi refresh roster: `{error}`. Thử lại sau vài phút nha.",
      localNewLinkUnavailableTitle: "Local Reader chưa khả dụng",
      localNewLinkUnavailableDescription: "Máy chủ chưa cấu hình URL công khai cho Local Reader. Báo Manager kiểm tra `PUBLIC_BASE_URL` nhé.",
      localNewLinkFailedTitle: "Không tạo được link mới",
    ...
    taskView: {
      ...
      viewToggleSyncDescription: "Duyệt preview Local Reader gửi về rồi đồng bộ ngay tại đây",
    ...
    goldView: {
      ...
      mainDescription: "Auto mặc định chỉ tính raid có gold unbound. Raid full bound không tự ăn slot; cậu có thể ép nhận hoặc tắt nhận bằng dropdown bên dưới.",
      emptyDescription: "Chưa có character gold-earner đủ điều kiện trong account này.\n\nDùng `/raid-gold-earner roster:<tên>` để chọn character ăn gold trước nha. Cap gold raid hiện là **{cap} raid / character**.",
      allAccounts: "🌐 Tổng gold tất cả roster: **{earned}** / **{total}**{boundTail}",
      accountLine: "💰 Gold nhận account này: **{earned}** / **{total}**{boundTail}",
      charSummary: "_Đang tính gold {counted}/{cap} raid_",
      manualOff: "không nhận gold",
      autoBound: "locked",
      outsideCap: "ngoài cap {cap} raid gold",
      moreCharacters: "_+{n} character gold khác_",
      charFilterPlaceholder: "Chọn character để setup gold...",
      noGoldPlaceholder: "Chưa có character ăn gold trong account này",
      charNoRaidPlaceholder: "{name} chưa có raid đủ điều kiện",
      togglePlaceholder: "Toggle raid nhận gold của {name}...",
      toggleReceiving: "nhận gold #{rank}",
      toggleAutoReceiving: "auto nhận #{rank}",
      toggleOutsideCap: "ngoài cap",
      toggleManualOn: "ép nhận",
      toggleManualOff: "không nhận",
      toggleAutoBound: "auto bỏ qua locked",
      toggleFailedTitle: "Không đổi được gold nhận",
      toggleFailedDescription: "Artist không lưu được lựa chọn này. Session có thể đã cũ hoặc roster/character vừa được cập nhật; mở lại `/raid-status` rồi thử lại nhé.",
      replaceRequiredTitle: "Đủ {cap}/{cap} slot gold rồi",
      replaceRequiredDescription: "**{characterName}** đang nhận đủ **{cap}/{cap}** raid gold. Muốn lấy gold từ **{targetRaid}** thì chọn 1 raid bên dưới để Artist bỏ tick gold trước nha.",
      replacePlaceholder: "Chọn raid sẽ bỏ tick gold...",
      replaceTimeoutTitle: "Chưa đổi gold nhận",
      ...
      modeTimingReset: "sau reset",
      modeOptionDesc: "{current} → {target} · {timing} · {gold}",
      modeCancelDesc: "Huỷ đổi đã hẹn",
      modeAppliedTitle: "Độ khó đổi rồi",
      modeAppliedDescription: "Artist chỉnh **{raidLabel}** của **{characterName}** sang **{mode}** ngay từ giờ nha~ Tuần này chưa chạy nên đổi liền được.",
      modeDeferredTitle: "Hẹn đổi độ khó rồi",
      modeDeferredDescription: "Tuần này **{characterName}** chạy **{raidLabel}** rồi, nên Artist để dành nhé: sau lần reset tới nó sẽ thành **{mode}**~",
      modeCancelledTitle: "Giữ nguyên độ khó",
      modeCancelledDescription: "Okie, **{raidLabel}** của **{characterName}** giữ nguyên **{mode}** nha~",
      modeIneligibleTitle: "Chưa đủ item level",
      modeIneligibleDescription: "**{raidLabel} {mode}** chưa mở cho char này đâu, lên thêm ilvl rồi quay lại nha~",
      modeFailedTitle: "Chưa lưu được",
      modeFailedDescription: "Artist chưa lưu được lựa chọn này. Session có thể đã cũ; mở lại `/raid-status` rồi thử lại giúp tớ nhé.",
      footerGold: "Gold {earned}/{total}",
      footerBound: "Khóa {bound}",
    },
  },
  "raid-set": {
    autocomplete: {
    ...
    already: {
      completeTitle: "Raid này xong từ trước rồi nha~",
  ...
  "raid-check": {
    ...
    notice: {
      ...
      noFilterMatchesTitle: "Không có roster phù hợp bộ lọc",
    ...
    filter: {
      userPlaceholder: "Lọc / chuyển tới user...",
      rosterPlaceholder: "📁 Lọc theo roster...",
      raidPlaceholder: "Lọc theo raid...",
      ...
      raidDone: "{label} (đã xong)",
      raidPending: "{label} ({n} chưa clear · {supports}🛡️ {dps}⚔️)",
    },
    buttons: {
    ...
    refreshFlow: {
      ...
      failedTitle: "Refresh roster fail",
      failedDescription: "Artist gặp lỗi khi refresh roster: `{error}`. Thử lại sau vài phút nha.",
    },
    editFlow: {
  ...
  "raid-auto-manage": {
    ...
    localEnable: {
      ...
      successDescription: "Local-sync mode đã bật, nhưng Artist chưa tạo được link Local Reader. Nhờ Manager kiểm tra cấu hình và log, rồi mở `/raid-status` → `🗃️ Local Sync` để thử lấy link mới. Cậu vẫn có thể dùng `/raid-set` thủ công. Đổi ý thì `action:local-off`.",
      successDescriptionWithLink: "Local-sync mode đã bật xong nha~ Bấm **Mở Local Reader**, chọn `encounters.db` lần đầu rồi gửi preview sang Discord. Sau đó mở `/raid-status` → `🗃️ Local Sync` để kiểm tra và xác nhận. Reader nhớ file; link có hiệu lực 30 phút và có thể làm mới tại đó. Đổi ý thì `action:local-off`.",
      openButtonLabel: "Mở Local Reader",
    },
    localDisable: {
      title: "Local-sync đã tắt",
      description: "Local-sync mode đã tắt. Artist không thể tự xoá file permission trong browser; nếu muốn dọn sạch, mở Local Reader, bấm **Bỏ file**, rồi xoá quyền của site trong cài đặt browser.",
    },
    disable: {
    ...
    enable: {
      ...
      noRosterDescription: "Auto-manage bật rồi. Chưa có roster nên tớ chưa sync được gì - chạy `/raid-add-roster` trước rồi gọi `/raid-auto-manage action:sync` để pull logs.",
    ...
    autocomplete: {
      ...
      localOnLabel: "local-on - bật Local Reader + xác nhận preview ở Discord",
    ...
    reset: {
      ...
      cancelButton: "Huỷ",
      cancelTitle: "Giữ nguyên, không reset",
      cancelTimeoutTitle: "Hết giờ nên tớ không reset gì cả",
      cancelDescription: "Không có gì thay đổi. Data của cậu nguyên vẹn.",
      successTitle: "Reset xong",
      successDescription: "Sync state và raid progress của cậu đã bị xoá. Roster, char và tasks vẫn giữ nguyên. Chạy `/raid-auto-manage action:on` (bible) hoặc `action:local-on` (Local Reader + xác nhận Discord) để sync replay từ đầu.",
  ...
  "raid-task": {
    ...
    sharedAdd: {
      ...
      capReachedTitle: "Hết slot task chung",
    ...
    clear: {
      ...
      successTitle: "Clear xong",
      successDescription: "Xoá **{taskCount}** task của **{characterName}** ({dailyCount} daily · {weeklyCount} weekly).",
      cancelledTitle: "Không xoá gì cả",
  ...
  "raid-channel": {
    ...
    set: {
      ...
      successDescription: "Bot sẽ monitor <#{channelId}> và parse clear dạng `<raid...> <difficulty> <character...> [gate]`, hoặc reset dạng `<raid...> reset <character...>`.",
      examplesField: "Examples",
      examplesValue: "`Act4 Final HM A B` → DONE cả 2 raid cho A và B\n`Act4 Solo Priscilladuk` → mark toàn bộ Act 4 Solo DONE\n`Serca Nor Soulrano G1` → mark G1 done\n`Act4 rs Clauseduk` → reset mọi gate Act 4",
    ...
    cleanup: {
      ...
      successDescription: "Dọn xong <#{channelId}>, pinned messages vẫn nguyên.",
  ...
  "raid-announce": {
    ...
    toggle: {
      ...
      successTitle: "Trạng thái đổi rồi",
    ...
    sections: {
      ...
      "raid-status": {
        ...
        notes: [
          ...
          "**Auto-refresh**: roster (iLvl/class) tự update mỗi 2h, và có nút `🔄 Refresh roster` để kéo lại dữ liệu roster ngay cho account đang xem. Nếu cậu opt-in `/raid-auto-manage` thì progress raid cũng auto-sync luôn từ bible.",
          ...
          "**Solo**: Act 4/Kazeros/Serca Solo vẫn hiện trong card và dropdown raid với pending riêng, nhưng không cộng vào tổng pending/success ở all-raids, roster, header hay footer. Horizon không có Solo.",
          ...
          "**🗃️ Local Sync**: view này nằm trực tiếp trong khung `/raid-status`. Chọn để xem preview mới nhất từ `encounters.db` rồi Đồng bộ / Huỷ / Làm mới ngay tại chỗ, xong lại đổi view khác mà không mất tin nhắn. Chưa bật sync mode thì view vẫn mở được nhưng chỉ hướng dẫn cách bật, không có nút nào.",
      ...
      "raid-auction": {
        ...
        notes: [
          ...
          "",
          "**Một lần nhập, hai size**: chỉ cần nhập giá listing trên AH, Artist hiện bid cho CẢ party 4 lẫn 8 cùng lúc - không cần chọn size trước.",
          "**Công thức**: bid = floor(0.95 × giá_listing × (N-1)/N). `0.95` = phí bán 5% trên AH (đã tính sẵn - cậu nhập giá listing nguyên, không cần tự trừ); `(N-1)/N` = phần chia cho người còn lại.",
          "**Profit mode** (mặc định bật): nhân thêm 0.92 (biên lời 8%) để thắng vật phẩm vẫn lời so với mua ngoài market.",
          "**Output mỗi size**: số bid (copy-paste vào ô đấu giá in-game), mỗi người còn lại nhận bao nhiêu, và lời ước tính của người thắng so với giá listing.",
          "**Public**: kết quả hiện cho cả kênh để party bid theo. Riêng lỗi nhập sai thì ẩn (chỉ mình cậu thấy).",
        ],
        optionDescriptions: {
          market_value: "Giá listing trên AH của vật phẩm (vàng). Artist tự trừ phí bán 5%.",
      ...
      "raid-schedule-preview": {
        ...
        notes: [
          ...
          "**Tham gia**: member bấm nút, chọn character đủ iLvl (char đã clear raid này tuần này được ẩn đi), bot tự xếp Support/DPS và đưa người dư vào hàng chờ.",
          "**RSVP**: `Đến muộn` vẫn giữ slot; `Có thể` và `Vắng` nhường slot cho hàng chờ.",
          "**Manage**: lead bấm Quản lý để Khóa/Mở khóa, End, đặt phòng/mật khẩu, sửa giờ, hủy event, 🧩 Phân turn, ➕ Thêm người, 👋 Kick, hoặc 🗑️ Xóa.",
          "**🔔 Chế độ im lặng (`skip_notify`)**: trường bắt buộc khi tạo. Bật = không ping ai khi add/kéo chờ/hủy/xóa (board vẫn cập nhật, clear vẫn ghi - chỉ tắt thông báo). Đổi bất kỳ lúc nào bằng nút 🔔/🔕 trong Quản lý.",
      ...
      "raid-set": {
        ...
        notes: [
          ...
          "**Solo**: autocomplete `raid:` có `Act 4 Solo`, `Kazeros Solo`, `Serca Solo`; Horizon không hỗ trợ Solo.",
          "**Alternative nhanh hơn**: post `Act4 Solo Nailaduk` hoặc `Final Hard Nailaduk G1` để update; `Final rs Nailaduk` reset mọi gate mà vẫn giữ mode.",
      ...
      "raid-check": {
        ...
        notes: [
          ...
          "**Filter dropdown**: user + roster + raid + status giúp thu hẹp overview mà không phải gõ lại lệnh. Pick 1 user sẽ hiện dropdown 📁 roster; mỗi roster có số pending/success và roster không khớp raid/status đang chọn sẽ bị ẩn. Cùng lúc đó có `Edit progress` / `Bật/Tắt auto-sync hộ`; `📝 Xem tasks` là read-only.",
          ...
          "**Solo**: không xuất hiện trong `/raid-check` hay Edit progress vì Solo không cần ghép đội; xem tiến độ Solo ở dropdown raid của `/raid-status`.",
      ...
      "raid-channel": {
        ...
        notes: [
          ...
          "• `Final Hard Soulrano G1` (Final là alias của Kazeros; mark G1 cumulative đến G_N)",
          "• `Act4 Solo Priscilladuk` (mark toàn bộ Act 4 Solo done)",
          "• Multi-raid × multi-char: `Act4, Final Hard A, B, C` (mỗi char nhận cả 2 raid)",
          "• Reset mọi gate: `Act4 reset A` hoặc `Act4 rs A` (không thêm difficulty/gate; giữ nguyên mode)",
          "**Aliases**: act4/armoche · kazeros/kaz/final · serca · horizon/cathedral/hc · solo (chỉ Act4/Kazeros/Serca) · normal/nor/nm/level1/l1 · hard/hm/level2/l2 · nightmare/9m/level3/l3 · reset/rs. Lưu ý `nm` = Normal.",
      ...
      "raid-auto-manage": {
        ...
        notes: [
          "Hai mode song song: **bible** (`action:on`, public log) và **local-sync** (`action:local-on`, Local Reader đọc encounters.db trên máy rồi gửi preview sang Discord). Mỗi lần chỉ bật 1 mode - mutex enforce ở DB.",
          "",
          "**Khi nào dùng bible mode**: lười post text + OK với việc bật Public Log trên lostark.bible. Bật 1 lần, bot tự pull mỗi 30 phút.",
          "**Khi nào dùng local-sync**: muốn giữ log private. Local Reader chạy SQLite trong browser, nhớ file handle và chỉ gửi delta preview; file gốc không upload.",
          ...
          "**`action:local-on` flow**: mint URL signed-token (TTL 30 phút) và trả trong reply riêng tư. Mở Local Reader → chọn file lần đầu → gửi preview → mở `/raid-status` → `🗃️ Local Sync` để kiểm tra char/raid/gate và bấm Đồng bộ. Preview lưu 2 giờ; scan mới thay preview pending cũ.",
        ...
        optionDescriptions: {
          ...
          "action:local-on": "Bật local-sync mode + mint URL Local Reader (reply riêng tư kèm link)",
      ...
      "raid-bg": {
        label: "/raid-bg",
        short: "Set / xem / sửa thư viện background cho card /raid-status",
  ...
  "text-parser": {
    ...
    dmFallbackAlreadyReset: "{names} vốn đã trống progress ở **{scope}**",
  ...
  welcome: {
    ...
    examplesValue: [
      "`Serca Nightmare Clauseduk` → DONE toàn bộ gate",
      "`Final Hard Soulrano G1` → mark G1 Kazeros và confirm dưới tên Final",
      "`Act4 Solo Priscilladuk` → DONE toàn bộ gate Act 4 Solo",
      "`Serca Nor Soulrano G2` → mark **G1 + G2** theo kiểu cumulative",
      "`Act4, Final HM Priscilladuk, Nailaduk` → DONE cả 2 raid cho cả 2 character",
      "`Act4 reset Priscilladuk` → xóa mọi gate, giữ difficulty đang lưu",
    ],
    ...
    aliasesValue: [
      ...
      "**Difficulty**: `solo` (chỉ Act 4/Kazeros/Serca) · `normal` / `nor` / `nm` · `hard` / `hm` · `nightmare` / `9m`",
      "**Horizon level**: `level1` / `l1` · `level2` / `l2` · `level3` / `l3`",
      "**Gate**: `G1`, `G2` - chỉ dùng khi muốn đánh dấu đúng 1 gate",
      "**Reset**: `reset` / `rs` - chỉ reset toàn raid, không thêm difficulty hay gate",
      "**Thứ tự**: raid(s) trước difficulty/reset · space, `+`, hay `,` đều dùng được",
    ],
    ...
    notesValue: [
      ...
      "• Sai raid/char → Artist không update phần nào và nhắc post lại. Thiếu iLvl, sai difficulty/gate cũng sẽ được báo rõ.",
      ...
      "• Gỡ một lượt clear bằng `<raid> reset <character>` (hoặc `rs`); xóa mọi gate nhưng giữ difficulty.",
    ...
    autoManageValue: [
      ...
      "**Local-sync mode** - `/raid-auto-manage action:local-on`: muốn giữ log private? Local Reader đọc `encounters.db` rồi gửi preview nhỏ sang Discord, cậu duyệt trong view `🗃️ Local Sync` của `/raid-status`; file gốc không upload đâu nha.",
    ...
    goldValue: [
      "Mở `/raid-status` all-raid view để xem dòng `💰 đã kiếm / tổng G` trên mỗi gold-earner + rollup `💰 Roster` cộng dồn roster đang xem. Phần `🔒 ...` cho biết lượng gold bound trong tổng đó. Khi lọc 1 raid cụ thể, dòng gold từng char sẽ ẩn đi cho gọn, còn rollup vẫn được giữ.",
      ...
      "Trong view Gold nhận của `/raid-status`, dùng dropdown độ khó để set mode raid cho từng character. Nếu tuần này raid đã chạy, Artist sẽ queue đổi sau reset tuần kế tiếp.",
    ],
  ...
  announcements: {
    ...
    "stuck-nudge": {
      body: "<@{discordId}> nhắc khẽ nhé~ Roster cậu đã bật auto-manage nhưng hiện tại tất cả char đều là private log, Artist không sync được data đâu. Hai cách: (1) bật **Show on Profile** ở https://lostark.bible/me/logs cho char cần sync, hoặc (2) bấm **Switch to Local Sync** - Local Reader đọc `encounters.db` trên máy, gửi preview sang Discord để cậu xác nhận, không cần public log và không upload file gốc. Biển báo này Artist cuỗm đi sau 30 phút.",
      switchButtonLabel: "Switch to Local Sync",
    },
    "world-event-reminder": {
      chaosGate: "🌪️ **Chaos Gate** sắp xuất hiện <t:{spawnUnix}:R> (lúc <t:{spawnUnix}:t>). Chuẩn bị vào event nhé~ Tin nhắc này tự biến mất sau 6 phút.",
      fieldBoss: "👹 **Field Boss** sắp xuất hiện <t:{spawnUnix}:R> (lúc <t:{spawnUnix}:t>). Chuẩn bị săn boss nhé~ Tin nhắc này tự biến mất sau 6 phút.",
      both: "🌪️ **Chaos Gate** và 👹 **Field Boss** sắp xuất hiện <t:{spawnUnix}:R> (lúc <t:{spawnUnix}:t>). Chủ nhật có cả hai, nhớ chọn event cần làm nhé~ Tin nhắc này tự biến mất sau 6 phút.",
    },
    "cleanup-volume": {
      empty: [
  ...
  raidBg: {
    ...
    set: {
      ...
      imagesLabel: "🖼️ Ảnh",
      imagesValue: "Lưu {count}/{max} ảnh · tổng {totalKb} KB",
      modeLabel: "🔀 Cách chia",
      mode: {
        even: "Chia đều",
