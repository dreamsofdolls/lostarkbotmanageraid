...
module.exports = {
  ...
  "raid-schedule": {
    ...
    notice: {
      ...
      invalidTimeDescription: "Cậu nhập kiểu nào cũng được nha: `20:00`, `20h`, `21h30`, `21g`, `20.30`, `2000`, `8pm`, hay `+2h`/`+90m`. Giờ kiểu đồng hồ Artist hiểu theo timezone trong `/raid-language` của cậu.",
    ...
    sections: {
      ...
      "raid-schedule-preview": {
        ...
        notes: [
          ...
          "**show**: `/raid-schedule-preview show` đẩy lại board signup của cậu xuống cuối channel (xóa cũ + post lại, không để board ma) - tiện khi board bị trôi. Nếu cậu chạy nhiều board, dropdown 🗓 trên board cho cậu bump board nào cũng được. Chỉ Raid Manager.",
        ...
        optionDescriptions: {
          ...
          mode: "Độ khó",
          when: "Giờ bắt đầu: `20:00`, `20h`, `21h30`, `8pm`, `2000`, `+2h`, `+90m`...",
