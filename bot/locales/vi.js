    ...
    sections: {
      ...
      "raid-set": {
        ...
        notes: [
          ...
          "**Alternative nhanh hơn**: post `Act4 Solo Nailaduk` hoặc `Kazeros Hard Nailaduk G1` để update; `Kazeros rs Nailaduk` reset mọi gate mà vẫn giữ mode.",
      ...
      "raid-channel": {
        ...
        notes: [
          ...
          "**Aliases**: act4/armoche · kazeros/kaz · serca · horizon/cathedral/hc · solo (chỉ Act4/Kazeros/Serca) · normal/nor/nm/level1/l1 · hard/hm/level2/l2 · nightmare/9m/level3/l3 · reset/rs. Lưu ý `nm` = Normal (không phải Nightmare).",
