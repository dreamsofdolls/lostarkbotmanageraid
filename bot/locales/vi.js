...
module.exports = {
  ...
  "raid-auto-manage": {
    ...
    reset: {
      ...
      successDescription: "Sync state và raid progress của cậu đã bị xoá. Roster, char và tasks vẫn giữ nguyên. Chạy `/raid-auto-manage action:on` (bible) hoặc `action:local-on` (web companion) để sync replay từ đầu.",
  ...
  "text-parser": {
    ...
    successDmModeNoteValue: "Mode chuyển sang **{difficulty}** - progress mode cũ được clear cho state consistent.",
  },
  welcome: {
