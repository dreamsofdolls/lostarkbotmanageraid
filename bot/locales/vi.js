...
module.exports = {
  ...
  "raid-add-roster": {
    auth: {
      ...
      managerOnlyDescription: "Add roster cho người khác là privilege của Raid Manager nha~ Cậu muốn add cho mình thì bỏ option `target` đi rồi chạy lại là Artist sẽ làm ngay.",
      botTargetTitle: "Bot không có roster đâu nha~",
      botTargetDescription: "Bot không chơi Lost Ark được, Artist không add roster cho bot được. Cậu chọn user người chơi thay nhé.",
    },
    duplicate: {
      ...
      postFetchDescription: "Artist fetch bible xong thấy có chars trùng với account **{accountName}** đã saved của cậu - tránh tạo split nên Artist từ chối nha.\n\nMuốn add chars mới: `/raid-edit-roster roster:{accountName}`\nMuốn làm lại từ đầu: `/raid-remove-roster` rồi `/raid-add-roster`",
  ...
  "raid-remove-roster": {
    ...
    notFound: {
      ...
      noRosterDescription: "Cậu chưa có roster nào để xóa. Dùng `/raid-add-roster` trước nhé.",
