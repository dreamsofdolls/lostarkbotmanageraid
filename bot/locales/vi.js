...
module.exports = {
  ...
  "raid-schedule": {
    ...
    notice: {
      ...
      helpDescription: "Bấm **Tham gia** để chọn character. **Đến muộn** vẫn giữ chỗ cho cậu, **Có thể/Vắng** thì nhường chỗ cho người trong hàng chờ. Lead dùng **Quản lý** để Khóa/Mở khóa, End, đặt phòng, sửa giờ, kick member hoặc hủy event nha.",
    ...
    sections: {
      ...
      "raid-schedule-preview": {
        ...
        notes: [
          ...
          "**➕ Thêm người**: lead tự xếp người vào đội (chọn user → chọn char đủ iLvl trong roster họ). Chạy được cả khi board đang Khóa, và người được thêm sẽ nhận ping.",
