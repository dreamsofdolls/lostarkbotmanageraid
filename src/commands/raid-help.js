...
const HELP_SECTIONS = [
    ...
    },
    {
      ...
      options: [
        ...
        { name: "character", required: true, desc: "Character muốn gắn/xoá task (autocomplete theo roster của cậu)" },
        { name: "name", required: false, desc: "(add) Tên task, max 60 ký tự" },
      ...
      example: "/raid-task add character:Frostmourne name:Una Dailies reset:daily",
      notes: [
        ...
        "• **Toggle complete trong `/raid-status` Task view**: gõ `/raid-status` → bấm dropdown `📝 Side tasks` → bấm dropdown `Bấm để toggle complete...` để flip ✅/⬜. Không cần command riêng - command `/raid-task` chỉ để add/remove/clear schema, toggle complete là UI.",
