...
const HELP_SECTIONS = [
    ...
    },
    {
      ...
      notes: [
        ...
        "• **👑 Manager prefix trên character name**: char thuộc roster của Raid Manager (ID trong `RAID_MANAGER_ID`) render với prefix `👑 <charName>`. Non-manager char không có prefix. Không phân tier Owner vs Manager riêng - với 2-người deployment, cả 2 manager đều thân nhau nên single tier đủ.",
