...
const HELP_SECTIONS = [
    ...
    },
    {
      ...
      notes: [
        ...
        "• **Toggle complete trong `/raid-status` Task view**: gõ `/raid-status` → bấm dropdown `📝 Side tasks` → bấm dropdown `Toggle task của <char>...` để flip 🟢/⚪. Không cần command riêng - command `/raid-task` chỉ để add/remove/clear schema, toggle complete là UI.",
