 ...
 * scheduling.js
 *
 * Announcement timing + scheduler-tick math extracted from raid-command.js.
 ...
 *
 * Used by: raid-command.js (compose root), commands/raid-announce.js,
 * commands/raid-channel.js (via re-export from raid-command).
 */
...
function createSchedulingHelpers({
  ...
  // factory can be built before the lazy `let` bindings in raid-command.js
